...
if point_in_rectangle(mouse_x, mouse_y, 279, 184, 293, 198)
{
	...
	draw_rectangle_color(mouse_x+15, mouse_y+15, mouse_x+145, mouse_y+60, c_fuchsia, c_fuchsia, c_fuchsia, c_fuchsia, false)
	draw_sprite_ext(spr_dialog_box, -1, mouse_x+15, mouse_y+15, 0.3, 0.4, 0, #E09cff, 1)
	draw_text_ext_transformed_color(mouse_x+25, mouse_y+25, string("Tap into your hosts memories, maybe there is something useful here..."), 12, 220, 0.5, 0.5, 0, #E09cff, #E09cff, #E09cff, #E09cff, 1)
}
...
if point_in_rectangle(mouse_x, mouse_y, 326, 219, 340, 233)
{
	...
	draw_rectangle_color(mouse_x+15, mouse_y+15, mouse_x+145, mouse_y+60, c_fuchsia, c_fuchsia, c_fuchsia, c_fuchsia, false)
	draw_sprite_ext(spr_dialog_box, -1, mouse_x+15, mouse_y+15, 0.3, 0.4, 0, #E09cff, 1)
	draw_text_ext_transformed_color(mouse_x+25, mouse_y+25, string("Lets just turn these off... no pain no gain right? Doubles HP"), 12, 220, 0.5, 0.5, 0, #E09cff, #E09cff, #E09cff, #E09cff, 1)
}
...
draw_text_ext_transformed_color(200, 20, string("Overload the targets brain!"), 12, 320, 1, 1, 0, #E09cff, #E09cff, #E09cff, #E09cff, 1)